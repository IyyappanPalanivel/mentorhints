...
const Blogs = () => {
    ...
    const Blog = ({id,title,description}) => {
        return (
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="p-5">
                    <a href="#">
                        <h5 className="mb-2 text-lg font-normal font-sans tracking-tight">{title}</h5>
                    </a>
                    <p className="text-xs font-sans font-normal text-gray pb-2">{description}</p>
                    <a href="#" className="inline-flex items-center px-3 py-2 text-xs font-medium  font-sans text-center bg-brandSecondary rounded-lg hover:bg-brandPrimary focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Read more
    ...
    return (
        <div className='max-w-full items-center justify-center pt-4 md:p-8'>
            {/* Section title */}
