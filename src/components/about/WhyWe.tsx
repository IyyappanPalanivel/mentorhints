        ...
        <section className="w-full p-8 gap-4 text-center md:text-left bg-lightBlue md:flex md:flex-row-reverse items-center">
            <div className='md:w-2/3'>
                ...
                <ul className="list-disc pl-4 mt-4">
                    ...
                    <li><span className='font-semibold text-base'>Flexible Learning Options: </span>Whether you prefer in-person instruction or online learning, we've got you covered. Our flexible course offerings allow you to choose the format that best fits your schedule and learning style.</li>
                    <li><span className='font-semibold text-base'>Career Support: </span>Your success is our top priority. That's why we offer comprehensive career support services to help you achieve your professional goals. From resume writing workshops to mock interviews, we'll provide you with the tools and resources you need to land your dream job.</li>
                </ul>
            </div>
